        ...
        success (res) {
          if (res.statusCode == 200){
            ...
            for (var i = 0; i < res.data.data.barberList.length; i++) {
              ...
              res.data.data.barberList[i].barberName = res.data.data.barberList[i].barberName
              res.data.data.barberList[i].desc = "　" + res.data.data.barberList[i].barberName + "技师,今年" + res.data.data.barberList[i].barberAge + "岁,擅长洗剪吹,烫头染发等。\n联系电话: " + res.data.data.barberList[i].barberPhone + ",店内客户评分为: " + res.data.data.barberList[i].score
            }
